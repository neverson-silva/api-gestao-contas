...
@AllArgsConstructor
@NoArgsConstructor
public class GastosPessoaMesAnoDTO extends MesAnoChartDTO {

    private MutableList<TotalPessoaMesAnoDTO> totaisPessoa;

    public GastosPessoaMesAnoDTO(MesAnoChartDTO mesAnoChartDTO) {
